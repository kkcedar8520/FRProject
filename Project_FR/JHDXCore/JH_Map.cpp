...
//
//		m_obj.m_pContext->VSSetConstantBuffers(3, 1, I_PogMgr.GetBuffer().GetAddressOf());
//		m_obj.m_pContext->PSSetConstantBuffers(3, 1, pBuffers);
//
//		UINT offset = 0;
...
//	}
//
//	bool JH_Map::NoneLightRenderSet(KG_Camera* pCamera)
//	{
//		SetMatrix(nullptr, &pCamera->m_View, &pCamera->m_Proj);
//		UINT offset = 0;
//		UINT stride = sizeof(D3DXVECTOR3);
