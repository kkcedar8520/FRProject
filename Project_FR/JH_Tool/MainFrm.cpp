...
#include"JH_CreateMap.cpp"
#include"JH_LoadObject.cpp"

#include "MainFrm.h"
#include"JH_ObjPane.cpp"
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_TOOL_LOADOBJECT, &CMainFrame::OnToolLoadobject)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndObjCtrl.CreateEx(NULL, L"Object", this, CRect(0,0, 100, 100),
		TRUE, 1001, dwStyle);//1000 10001 고유 번호
...
void CMainFrame::OnToolLoadobject()
{
	static JH_LoadObject dlg;
	if (dlg.GetSafeHwnd() == NULL)
	{
		dlg.Create(IDD_JH_LoadObject);
	}
